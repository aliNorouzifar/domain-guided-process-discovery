...
TEST_BASE_NAME="ERROR-INJECTION-WHITE-NOISE"
...
for EXCLUDED in "a" "b" "c" "d" "ef" "gh" "il" "mn" "op" "qr" "st" "uv" "wx" "yz" "jk" "ü§"; do
  ...
  ## Plot results
  echo "########### Plot results"
  /home/alessio/Data/Phd/my_code/PyVEnv/pySupport/bin/python pySupport/error_injection_plots.py $OUTPUT_CHECK_JSON"AggregatedMeasures[MEAN]_" $ITERATIONS ${TEST_FOLDER}/${TEST_BASE_NAME}"/" $EXCLUDED $ERROR_TYPE
