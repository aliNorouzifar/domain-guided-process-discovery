...
TEST_BASE_NAME="GROUND-TRUTH-NEU-NOISE"
...
for ITERATION in $(seq 1 ${ITERATIONS}); do
  ...
  echo "########### SJ2T Check"
  java -cp Janus-NEU.jar $JANUS_CHECK_MAINCLASS -iLF $ERROR_LOG -iLE $LOG_ENCODING -iMF $SIMPLE_MODEL_JSON -iME $MODEL_ENCODING -oCSV $OUTPUT_CHECK_CSV -oJSON $OUTPUT_CHECK_JSON $NaN_LOG -detailsLevel $DETAILS_LEVEL
